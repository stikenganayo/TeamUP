...
class SelectTeamsScreen extends StatefulWidget {
  const SelectTeamsScreen({Key? key}) : super(key: key);

  @override
  _SelectTeamsScreenState createState() => _SelectTeamsScreenState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text('Selected Teams:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          Wrap(
