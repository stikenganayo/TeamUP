...
class CommunityCoachRequestScreen extends StatefulWidget {

  const CommunityCoachRequestScreen({Key? key, required this.coachId}) : super(key: key);

  final String coachId; // Add type String here
  @override
  _CommunityCoachRequestScreenState createState() => _CommunityCoachRequestScreenState();
}

class _CommunityCoachRequestScreenState extends State<CommunityCoachRequestScreen> {
